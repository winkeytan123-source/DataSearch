...
class MetricQdrantRepository:
    ...
    async def upsert(self, ids: list[str], embeddings: list[float], payloads: list[MetricInfoQdrant],
                     batch_size: int = 20):
    ...
    async def search_with_score(self, embedding: list[float], score_threshold: float = 0.6, limit: int = 20) -> list[dict]:
        ...
        return [{"payload": MetricInfoQdrant(**point.payload), "score": point.score} for point in result.points]
